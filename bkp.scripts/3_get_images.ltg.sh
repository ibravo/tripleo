...
wget http://katello.hq.ltg/deploy-ramdisk-ironic.kernel 
wget http://katello.hq.ltg/deploy-ramdisk-ironic.tar 
wget http://katello.hq.ltg/ironic-python-agent.initramfs 
wget http://katello.hq.ltg/ironic-python-agent.kernel 
wget http://katello.hq.ltg/ironic-python-agent.tar 
wget http://katello.hq.ltg/ironic-python-agent.vmlinuz
wget http://katello.hq.ltg/overcloud-full.initrd 
wget http://katello.hq.ltg/overcloud-full.qcow2
wget http://katello.hq.ltg/overcloud-full.tar 
wget http://katello.hq.ltg/overcloud-full.vmlinuz
